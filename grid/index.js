...
var GridChildWrapper = styles_1.styled('div', function (_a) {
    var _b;
...
exports.Grid = function (props) {
    ...
    return (react_1.default.createElement(Component, { className: className, style: __assign({ display: 'flex', boxSizing: 'border-box', flexDirection: direction, flexWrap: wrap, justifyContent: center ? 'center' : justifyContent, alignItems: center ? 'center' : alignItems }, style) }, react_1.default.Children.toArray(children).map(function (child, index) {
        return react_1.default.createElement(GridChildWrapper, __assign({}, { index: index, spacing: spacing, spacings: spacings, placement: placement, placements: placements, direction: direction }), child);
    })));
};
exports.TestItem = function (_a) {
    var t = _a.t, _b = _a.style, style = _b === void 0 ? {} : _b;
    return react_1.default.createElement(exports.Grid, { center: true, style: __assign({ height: '50px', width: '100%', border: '1px solid blue' }, style) }, t);
};
